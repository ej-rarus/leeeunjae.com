...
export const projects: Project[] = [
  ...
  },
  {
    ...
    technologies: ["Shopify Plus", "Liquid", "JavaScript", "PM", "Spec Ownership"],
    ...
    detail: {
      ...
      solution: "PM으로서 진출 전략부터 시스템 설계·일정 관리·런칭까지 단독 리드. Shopify Plus 다국가 스토어 구조를 설계하고, 회원 등급·POS·ERP 연동까지 본사·현지·개발팀 간 의사결정과 산출물 흐름을 통합. 회의록 → 기능정의서 → 화면정의서 → WBS 체계를 정착시켜 다자 협업 비용을 크게 절감했습니다.",
      features: [
        "동아시아 3개 시장(대만·홍콩·마카오) 진출 프로젝트 단독 PM 리드",
        "Shopify Plus 다국가·다통화 스토어 아키텍처 설계",
        "본사 회원 등급 체계와 현지 등급의 이원화 구조 정의",
        "POS 주문 아키텍처 설계 + ERP·물류 연동 흐름 정의",
        "본사·현지 파트너·개발 벤더 간 요구사항 정렬, 우선순위·일정 통제",
        "회의록 → 기능정의서 → 화면정의서 → WBS 표준 워크플로우 정착",
      ],
      role: "PM · 프로젝트 총괄 리드",
